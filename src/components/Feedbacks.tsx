...
const FeedbackCard = ({ testimonial, index }: { index: number, testimonial: any }) => {
    ...
    >
      ...
      <div className="mt-1 ">
        ...
        <div className="mt-7 flex justify-between items-center gap-1">
          ...
          <img src={testimonial.image} alt={`feedback-by-${testimonial.name}`} className="w-10 h-10 rounded-full object-cover" />
        </div>
      </div>
    </motion.div>
  )
